...
function Controller(canvasId){
	...
	this.imageSources = {
		...
		levelBounds: "dosa1.jpg",
		level: "dosa2.jpg",
		heroSprites: "dosa3.jpg",
		heroHitSprites: "dosa4.jpg",
		badGuySprites: "dosa5.jpg",
		badGuyHitSprites: "dosa6.jpg",
		background: "dosa1.jpg",
		readyScreen: "dosa2.jpg",
		gameoverScreen: "dosa3.jpg",
		winScreen: "dosa4.jpg"
	...
	Controller.prototype.loadImages = function(){
		...
		this.view.canvas.style.background = "url('dosa1.png')";
				...
				setTimeout(function(){
					...
					for (var n = 0; n < model.badGuys.length; n++) {
						...
						(function(){
							...
							if (model.nearby(hero, badGuy) && ((badGuy.x - hero.x > 0 && hero.isFacingRight()) || (hero.x - badGuy.x > 0 && !hero.isFacingRight()))) {
								badGuy.damage();
							}
